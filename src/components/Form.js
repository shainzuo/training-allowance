...
export default function Form()  {
   ...
   const submitForm = e => {
        ...
        setForm({ pop: true, name : '', svn: '', yis: '', doe: '', email: '', phone_no: '',  })
    }
        ...
        {  form.pop ? ( <Popup /> ) : null  }
            <div className="hidden lg:block relative w-full lg:w-1/2 bg-green-600">
                <div className="absolute bottom-0 inset-x-0 mx-auto mb-12 max-w-xl text-center" style={{zIndex: 10}}>
                    ...
                    <h2 className="mb-2 text-2xl text-white font-bold">OPSEC CADRE COURSE DATABASE</h2>
                    <div className="max-w-lg mx-auto">
                        <p className="mb-6 text-gray-50 leading-loose">Submit your correct details.</p>
                    </div>
                </div>
            </div>
